function [task_solver] = task_goal_viapoint_solver_dmp(g,y0,evaluation_external_program, goal_learning)
task_solver.name = 'viapoint';
if (nargin<1), g   = [1 1]; end
if (nargin<2), y0  = [0 0]; end
if (nargin<3), evaluation_external_program = 0; end
if (nargin<4), goal_learning = 0; end
...
task_solver.theta_init = zeros(task_solver.order,length(task_solver.g));
