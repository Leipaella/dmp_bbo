...
%There arise many situations where the policy parameter vector $\app$ is dependent on the context. The context is the set of relevant task parameters $\taskp$ which have an influence on the values of the policy parameters. 
...
\subsection{Parameterizing Policies with Task Parameters}
